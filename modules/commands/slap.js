...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "slap.png")) request("https://raw.githubusercontent.com/ProCoderMew/Module-Miraiv2/Mew/data/slap.png").pipe(fs.createWriteStream(dirMaterial + "slap.png"));
}
