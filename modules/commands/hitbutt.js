...
module.exports.onLoad = () => {
    ...
    if (!fs.existsSync(dirMaterial + "hit_butt.png")) request("https://raw.githubusercontent.com/ProCoderMew/Module-Miraiv2/Mew/data/hitbutt.png").pipe(fs.createWriteStream(dirMaterial + "hit_butt.png"));
}
